...
class Imagen_array(object):
    def __init__(self, array):
        self.array = array
    def array(self):
        array = self.array()
        return array
    def processing(self, img_healthy):
        img_inj = self.array()
    ...
    def resize(self, shape_input):
        resized_image = cv2.resize(self.array(), (shape_input[0], shape_input[1]), interpolation = INTER_LINEAR_EXACT)
